...
import { Matter, Meeting } from '../../src/types';
...
export default function MatterDetailScreen() {
  ...
  const loadData = async () => {
    ...
    const [matterData, meetingsData] = await Promise.all([
      db.getMatter(id),
      db.getMeetingsByMatter(id),
    ]);
  ...
  const handleDeleteMatter = () => {
    Alert.alert(
      'Delete Matter',
      `Are you sure you want to delete "${matter?.name}"? This will also delete all associated meetings.`,
      [
    ...
    <>
      <Stack.Screen
        options={{
          title: matter.name,
          headerRight: () => (
            <TouchableOpacity onPress={handleDeleteMatter} style={styles.headerButton}>
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptySubtext}>
                Record your first meeting for this matter
              </Text>
              <TouchableOpacity style={styles.recordButton} onPress={handleNewMeeting}>
